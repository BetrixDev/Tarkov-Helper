...
import { AutocompleteInteraction, CommandInteraction, MessageEmbed, MessageEmbedOptions } from 'discord.js'
        ...
        return {
            embeds: [
                new MessageEmbed()
                    ...
                    .setTitle(
                        `${item.shortName} Stats - ${
                            itemData.CanSell ? FormatPrice(item.lastLowPrice) : "Can't sell on Flea"
                        }`
                    )
                    .setDescription(
                        `
