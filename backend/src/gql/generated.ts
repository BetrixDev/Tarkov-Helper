...
export type Item = {
  ...
  readonly conflictingSlotIds: Maybe<ReadonlyArray<Maybe<Scalars['String']['output']>>>;
...
export type ItemPropertiesScope = {
  ...
  readonly slots: Maybe<ReadonlyArray<Maybe<ItemSlot>>>;
  readonly zoomLevels: Maybe<ReadonlyArray<Maybe<ReadonlyArray<Maybe<Scalars['Float']['output']>>>>>;
};
...
export type QueryItemsArgs = {
  ...
  bsgCategoryIds: InputMaybe<ReadonlyArray<InputMaybe<Scalars['String']['input']>>>;
...
export type QuestRequirement = {
  ...
  /** @deprecated Use Task type instead. */
  readonly quests: ReadonlyArray<Maybe<ReadonlyArray<Maybe<Scalars['Int']['output']>>>>;
};
...
export type AllQuery = { readonly __typename?: 'Query', readonly barters: ReadonlyArray<{ readonly __typename?: 'Barter', readonly id: string, readonly level: number, readonly trader: { readonly __typename?: 'Trader', readonly id: string }, readonly requiredItems: ReadonlyArray<{ readonly __typename?: 'ContainedItem', readonly count: number, readonly item: { readonly __typename?: 'Item', readonly id: string, readonly name: string }, readonly attributes: ReadonlyArray<{ readonly __typename?: 'ItemAttribute', readonly type: string, readonly name: string, readonly value: string }> }>, readonly rewardItems: ReadonlyArray<{ readonly __typename?: 'ContainedItem', readonly count: number, readonly item: { readonly __typename?: 'Item', readonly id: string, readonly name: string }, readonly attributes: ReadonlyArray<{ readonly __typename?: 'ItemAttribute', readonly type: string, readonly name: string, readonly value: string }> }> }>, readonly traders: ReadonlyArray<{ readonly __typename?: 'Trader', readonly normalizedName: string, readonly id: string }>, readonly items: ReadonlyArray<{ readonly __typename?: 'Item', readonly id: string, readonly name: string, readonly shortName: string, readonly image512pxLink: string, readonly types: ReadonlyArray<ItemType>, readonly width: number, readonly height: number, readonly wikiLink: string, readonly sellFor: ReadonlyArray<{ readonly __typename?: 'ItemPrice', readonly price: number, readonly priceRUB: number, readonly vendor: { readonly __typename?: 'FleaMarket', readonly normalizedName: string } | { readonly __typename?: 'TraderOffer', readonly normalizedName: string } }>, readonly buyFor: ReadonlyArray<{ readonly __typename?: 'ItemPrice', readonly price: number, readonly priceRUB: number, readonly vendor: { readonly __typename?: 'FleaMarket', readonly normalizedName: string } | { readonly __typename?: 'TraderOffer', readonly normalizedName: string } }>, readonly properties: { readonly __typename: 'ItemPropertiesAmmo', readonly caliber: string, readonly stackMaxSize: number, readonly tracer: boolean, readonly tracerColor: string, readonly ammoType: string, readonly projectileCount: number, readonly damage: number, readonly armorDamage: number, readonly fragmentationChance: number, readonly penetrationPower: number, readonly accuracyModifier: number, readonly recoilModifier: number, readonly initialSpeed: number, readonly lightBleedModifier: number, readonly heavyBleedModifier: number, readonly durabilityBurnFactor: number, readonly heatFactor: number } | { readonly __typename: 'ItemPropertiesArmor', readonly class: number, readonly durability: number, readonly speedPenalty: number, readonly turnPenalty: number, readonly ergoPenalty: number, readonly zones: ReadonlyArray<string>, readonly material: { readonly __typename?: 'ArmorMaterial', readonly name: string } } | { readonly __typename: 'ItemPropertiesArmorAttachment', readonly class: number, readonly durability: number, readonly speedPenalty: number, readonly turnPenalty: number, readonly ergoPenalty: number, readonly headZones: ReadonlyArray<string>, readonly blindnessProtection: number, readonly material: { readonly __typename?: 'ArmorMaterial', readonly destructibility: number, readonly name: string } } | { readonly __typename: 'ItemPropertiesBackpack', readonly capacity: number, readonly grids: ReadonlyArray<{ readonly __typename?: 'ItemStorageGrid', readonly width: number, readonly height: number }> } | { readonly __typename: 'ItemPropertiesBarrel', readonly ergonomics: number, readonly recoilModifier: number, readonly slots: ReadonlyArray<{ readonly __typename?: 'ItemSlot', readonly name: string }> } | { readonly __typename: 'ItemPropertiesChestRig', readonly class: number, readonly durability: number, readonly speedPenalty: number, readonly turnPenalty: number, readonly ergoPenalty: number, readonly zones: ReadonlyArray<string>, readonly capacity: number, readonly material: { readonly __typename?: 'ArmorMaterial', readonly destructibility: number, readonly name: string }, readonly grids: ReadonlyArray<{ readonly __typename?: 'ItemStorageGrid', readonly width: number, readonly height: number }> } | { readonly __typename: 'ItemPropertiesContainer', readonly capacity: number, readonly grids: ReadonlyArray<{ readonly __typename?: 'ItemStorageGrid', readonly width: number, readonly height: number }> } | { readonly __typename: 'ItemPropertiesFoodDrink', readonly energy: number, readonly hydration: number, readonly units: number, readonly stimEffects: ReadonlyArray<{ readonly __typename?: 'StimEffect', readonly type: string, readonly chance: number, readonly delay: number, readonly duration: number, readonly value: number, readonly percent: boolean, readonly skillName: string }> } | { readonly __typename: 'ItemPropertiesGlasses', readonly class: number, readonly durability: number, readonly blindnessProtection: number, readonly material: { readonly __typename?: 'ArmorMaterial', readonly destructibility: number, readonly name: string } } | { readonly __typename: 'ItemPropertiesGrenade', readonly type: string, readonly fuse: number, readonly minExplosionDistance: number, readonly maxExplosionDistance: number, readonly fragments: number, readonly contusionRadius: number } | { readonly __typename: 'ItemPropertiesHeadphone' } | { readonly __typename: 'ItemPropertiesHelmet', readonly class: number, readonly durability: number, readonly speedPenalty: number, readonly turnPenalty: number, readonly ergoPenalty: number, readonly headZones: ReadonlyArray<string>, readonly deafening: string, readonly blocksHeadset: boolean, readonly material: { readonly __typename?: 'ArmorMaterial', readonly destructibility: number, readonly name: string }, readonly slots: ReadonlyArray<{ readonly __typename?: 'ItemSlot', readonly name: string }> } | { readonly __typename: 'ItemPropertiesKey', readonly uses: number } | { readonly __typename: 'ItemPropertiesMagazine', readonly ergonomics: number, readonly recoilModifier: number, readonly capacity: number, readonly loadModifier: number, readonly ammoCheckModifier: number, readonly malfunctionChance: number, readonly allowedAmmo: ReadonlyArray<{ readonly __typename?: 'Item', readonly properties: { readonly __typename?: 'ItemPropertiesAmmo', readonly caliber: string } | { readonly __typename?: 'ItemPropertiesArmor' } | { readonly __typename?: 'ItemPropertiesArmorAttachment' } | { readonly __typename?: 'ItemPropertiesBackpack' } | { readonly __typename?: 'ItemPropertiesBarrel' } | { readonly __typename?: 'ItemPropertiesChestRig' } | { readonly __typename?: 'ItemPropertiesContainer' } | { readonly __typename?: 'ItemPropertiesFoodDrink' } | { readonly __typename?: 'ItemPropertiesGlasses' } | { readonly __typename?: 'ItemPropertiesGrenade' } | { readonly __typename?: 'ItemPropertiesHeadphone' } | { readonly __typename?: 'ItemPropertiesHelmet' } | { readonly __typename?: 'ItemPropertiesKey' } | { readonly __typename?: 'ItemPropertiesMagazine' } | { readonly __typename?: 'ItemPropertiesMedKit' } | { readonly __typename?: 'ItemPropertiesMedicalItem' } | { readonly __typename?: 'ItemPropertiesMelee' } | { readonly __typename?: 'ItemPropertiesNightVision' } | { readonly __typename?: 'ItemPropertiesPainkiller' } | { readonly __typename?: 'ItemPropertiesPreset' } | { readonly __typename?: 'ItemPropertiesResource' } | { readonly __typename?: 'ItemPropertiesScope' } | { readonly __typename?: 'ItemPropertiesStim' } | { readonly __typename?: 'ItemPropertiesSurgicalKit' } | { readonly __typename?: 'ItemPropertiesWeapon' } | { readonly __typename?: 'ItemPropertiesWeaponMod' } }> } | { readonly __typename: 'ItemPropertiesMedKit', readonly hitpoints: number, readonly useTime: number, readonly maxHealPerUse: number, readonly cures: ReadonlyArray<string>, readonly hpCostLightBleeding: number, readonly hpCostHeavyBleeding: number } | { readonly __typename: 'ItemPropertiesMedicalItem', readonly uses: number, readonly useTime: number, readonly cures: ReadonlyArray<string> } | { readonly __typename: 'ItemPropertiesMelee', readonly slashDamage: number, readonly stabDamage: number, readonly hitRadius: number } | { readonly __typename: 'ItemPropertiesNightVision', readonly intensity: number, readonly noiseIntensity: number, readonly noiseScale: number, readonly diffuseIntensity: number } | { readonly __typename: 'ItemPropertiesPainkiller', readonly uses: number, readonly useTime: number, readonly cures: ReadonlyArray<string>, readonly painkillerDuration: number, readonly energyImpact: number, readonly hydrationImpact: number } | { readonly __typename: 'ItemPropertiesPreset' } | { readonly __typename: 'ItemPropertiesResource' } | { readonly __typename: 'ItemPropertiesScope', readonly ergonomics: number, readonly sightModes: ReadonlyArray<number>, readonly sightingRange: number, readonly recoilModifier: number, readonly zoomLevels: ReadonlyArray<ReadonlyArray<number>>, readonly slots: ReadonlyArray<{ readonly __typename?: 'ItemSlot', readonly name: string }> } | { readonly __typename: 'ItemPropertiesStim', readonly useTime: number, readonly cures: ReadonlyArray<string>, readonly stimEffects: ReadonlyArray<{ readonly __typename?: 'StimEffect', readonly type: string, readonly chance: number, readonly delay: number, readonly duration: number, readonly value: number, readonly percent: boolean, readonly skillName: string }> } | { readonly __typename: 'ItemPropertiesSurgicalKit', readonly uses: number, readonly useTime: number, readonly cures: ReadonlyArray<string>, readonly minLimbHealth: number, readonly maxLimbHealth: number } | { readonly __typename: 'ItemPropertiesWeapon', readonly caliber: string, readonly effectiveDistance: number, readonly fireModes: ReadonlyArray<string>, readonly fireRate: number, readonly maxDurability: number, readonly defaultAmmo: { readonly __typename?: 'Item', readonly id: string, readonly shortName: string }, readonly defaultPreset: { readonly __typename?: 'Item', readonly properties: { readonly __typename?: 'ItemPropertiesAmmo' } | { readonly __typename?: 'ItemPropertiesArmor' } | { readonly __typename?: 'ItemPropertiesArmorAttachment' } | { readonly __typename?: 'ItemPropertiesBackpack' } | { readonly __typename?: 'ItemPropertiesBarrel' } | { readonly __typename?: 'ItemPropertiesChestRig' } | { readonly __typename?: 'ItemPropertiesContainer' } | { readonly __typename?: 'ItemPropertiesFoodDrink' } | { readonly __typename?: 'ItemPropertiesGlasses' } | { readonly __typename?: 'ItemPropertiesGrenade' } | { readonly __typename?: 'ItemPropertiesHeadphone' } | { readonly __typename?: 'ItemPropertiesHelmet' } | { readonly __typename?: 'ItemPropertiesKey' } | { readonly __typename?: 'ItemPropertiesMagazine' } | { readonly __typename?: 'ItemPropertiesMedKit' } | { readonly __typename?: 'ItemPropertiesMedicalItem' } | { readonly __typename?: 'ItemPropertiesMelee' } | { readonly __typename?: 'ItemPropertiesNightVision' } | { readonly __typename?: 'ItemPropertiesPainkiller' } | { readonly __typename?: 'ItemPropertiesPreset', readonly ergonomics: number, readonly recoilVertical: number, readonly recoilHorizontal: number, readonly moa: number } | { readonly __typename?: 'ItemPropertiesResource' } | { readonly __typename?: 'ItemPropertiesScope' } | { readonly __typename?: 'ItemPropertiesStim' } | { readonly __typename?: 'ItemPropertiesSurgicalKit' } | { readonly __typename?: 'ItemPropertiesWeapon' } | { readonly __typename?: 'ItemPropertiesWeaponMod' } } } | { readonly __typename: 'ItemPropertiesWeaponMod', readonly ergonomics: number, readonly recoilModifier: number, readonly accuracyModifier: number, readonly slots: ReadonlyArray<{ readonly __typename?: 'ItemSlot', readonly name: string }> } }> };

export type TraderRestocksQueryVariables = Exact<{ [key: string]: never; }>;


export type TraderRestocksQuery = { readonly __typename?: 'Query', readonly traders: ReadonlyArray<{ readonly __typename?: 'Trader', readonly id: string, readonly resetTime: string }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    traderRestocks(variables?: TraderRestocksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<TraderRestocksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TraderRestocksQuery>(TraderRestocksDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'traderRestocks', 'query');
    }
  };
}
