...
if [ -d "game_data/" ]; then
    ...
    curl https://gist.githubusercontent.com/BetrixDev/ef7feb608ad04e700ae746414bad4983/raw/ee33272a6bf8138d0c5f86435970731c65efc86b/hideout.json >hideoutdata.json
